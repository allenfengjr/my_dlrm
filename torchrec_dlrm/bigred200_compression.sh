...
export EPOCH=1
export TRACE_PATH="/N/scratch/haofeng/trace_result/multi_process_every_epoch_4x4"
export SAVE_PATH="/N/scratch/haofeng/dlrm_models/"
export BATCH_SIZE=8192
#export NCCL_DEBUG=INFO
#export NCCL_DEBUG_SUBSYS=ALL
#export NCCL_TOPO_DUMP_FILE=~/new_dlrm/torchrec_dlrm/nccl_topo_allrank.xml
mkdir $TRACE_PATH
cd ~/new_dlrm/torchrec_dlrm/
source ~/.bashrc
conda init
conda activate dlrm
srun -n 16 python -u dlrm_main_compress.py --epochs=$EPOCH \
