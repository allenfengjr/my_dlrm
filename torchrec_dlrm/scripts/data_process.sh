...
# Step 0. Use self-defined conda environment
#conda init bash
#conda activate dlrm
...
date
python -m torchrec.datasets.scripts.shuffle_preproc  5_criteo --input_dir_labels_and_dense "$step_1_output_dir" --input_dir_sparse "$step_2_output_dir" --output_dir_shuffled "$step_3_output_dir" --random_seed 0 || exit
date
